...
<body>
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-4" id="employee_column">
                <!--人數-->
                <div class="numberDiv">
                    <i class="fa fa-child" style="display:inline-block"></i>
                    <div id="number" style="display:inline-block"></div>
                </div>
                ...
                <table class="student_table">
                    ...
                    <!--總覽-->
                    <tbody class="show" id="all">
                        @foreach ($employee as $Data)
                            <tr>
                                <td>{{($loop->index)+1}}</td> <!--編號-->
                                <td>{{$Data->staffID}}</td> <!--工號-->
                                <td>{{$Data->name}}</td> <!--職員姓名-->
